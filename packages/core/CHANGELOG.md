...
- ce331e8: fix(cache): prevent scalar patches from crossing FragmentSpread boundaries
...
- c5cbd35: fix(cache): denormalize embedded type values in patch output
...
- 499dc8d: fix(cache): mask root-level fragment spreads and propagate variables
